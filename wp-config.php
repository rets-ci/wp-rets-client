 ...
 *
 * ### 2.0
 * * Ported over branch-specific setting override from DDP/UD.
 * * Fixed bug with table_prefix not setting, breaking wp-cli.
 *
 *
 * @version 2.0
 * @author potanin@UD
...
namespace UsabilityDynamics\Cluster {
	...
	if ( ! isset( $wp_cluster ) || ! isset( $wp_cluster->config ) ) {
		global $wp_cluster, $table_prefix;
		...
		// check one more time (causes issues w/ wp-cli)
