...
defined('ABSPATH') or die("you do not have acces to this page!");
  ...
  public function init() {
    ...
    if (!$this->site_has_ssl || $this->wpconfig_issue || $is_settings_page || $this->plugin_activated() || $this->plugin_upgraded()) {
...
protected function get_server_variable_fix_code(){
  ...
  public function get_url_contents($url) {
    ...
    if ($this->curl_installed) {
        ...
        if ($this->debug) {$this->trace_log("Returned errorcode: ".$this->error_number);}
          ...
          <tr>
            ...
            <td><?php
                    if ( ($this->no_server_variable || $this->do_wpconfig_loadbalancer_fix) && !$this->wpconfig_is_writable())  {
                      echo __("Failed activating SSL","really-simple-ssl")."&nbsp;";
