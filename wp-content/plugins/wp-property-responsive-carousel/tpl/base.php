								...
								<a href="<?php the_permalink() ?>">
									...
									<div class="item-content">
										...
										<ul>
											...
											<?php $get_living_area_terms = get_the_terms($property['ID'], 'total_living_area_sqft'); if($get_living_area_terms[0]){ ?><li class="hidden-xs"><span class="icon-wpproperty-attribute-rooms-outline singlePropertyIcon"></span><?php _e($get_living_area_terms[0]->name . ' Sq.ft.'); echo '</li>'; } ?>
