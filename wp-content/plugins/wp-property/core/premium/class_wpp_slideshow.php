...
class class_wpp_slideshow {
   ...
   *
   */
  static public function get_global_images($type = false) {
    ...
    return isset( $good_images ) ? $good_images : array();
  }
  ...
  static public function settings_page() {
    ...
    <tr>
      ...
      <td>
        ...
        <li>
        <?php echo WPP_F::checkbox( "name=wpp_settings[configuration][feature_settings][slideshow][glob][link_to_property]&label=".__('Clicking on an image will open up the property its attached to.','wpp'), ( isset( $glob_slideshow['link_to_property'] ) ? $glob_slideshow['link_to_property'] : false ) ); ?>
        </li>

        <li>
        <?php echo WPP_F::checkbox("name=wpp_settings[configuration][feature_settings][slideshow][glob][show_property_title]&label=".__('Show property title and tagline in slideshow.','wpp'), ( isset( $glob_slideshow['show_property_title'] ) ? $glob_slideshow['show_property_title'] : false ) ); ?>
        </li>
   ...
   *
   */
  static public function shortcode_global_slideshow($atts = '') {
