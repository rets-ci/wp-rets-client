...
add_action( 'wpp_init', array( 'class_wpp_facebook_tabs', 'wpp_init' ) );
add_action( 'wpp_pre_init', array( 'class_wpp_facebook_tabs', 'wpp_pre_init' ) );
                ...
                <tr>
                  <th>
                    ...
                    <div class="description">
                      ...
                      <p><?php _e('You will need to create an app using your Facebook account.  Once the app is created, you will be able to add it to one of your pages.', 'wpp'); ?> <a target="_blank" href="https://developers.facebook.com/apps"><?php _e('Create Facebook App.', 'wpp'); ?></a></p>
                    </div>
                  </th>
                  <td>
                    <ul class="wpp_fb_canvas_options_list">
