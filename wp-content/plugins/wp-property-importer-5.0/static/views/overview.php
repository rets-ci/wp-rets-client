        ...
        <tr <?php echo implode( '', $this_row_data ); ?> class="wpp_i_schedule_row" schedule_id="<?php echo $sch_id; ?>" import_title="<?php echo esc_attr( $sch[ 'name' ] ); ?>">
          <td class="post-title column-title">
            <ul>
              ...
              <li>
                <?php _e( 'Cron Command:', ud_get_wpp_importer()->domain ); ?> <span class="wpp_i_overview_special_data">php -q <?php echo $cron_path . ' do_xml_import ' . $sch[ 'hash' ] . ( is_multisite() ? " " . parse_url( site_url(), PHP_URL_HOST ) . parse_url( site_url(), PHP_URL_PATH ) : '' ); ?></span>
              </li>
              <li>
