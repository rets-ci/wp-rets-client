...
1. Select a widget to edit.
1. In the dropdown box, select if you want to Show or Hide this widget.
1. Using the checkboxes, check the pages where you want the widget to show up (or be hidden).
1. Save the widget.
...
1. Widget Visibility settings inside a widget.
2. Widget Visibility also works in WordPress customizer. Here the widget is hidden from the front page.
