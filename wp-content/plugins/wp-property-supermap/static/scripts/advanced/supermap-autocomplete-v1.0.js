...
( function( jQuery, wpp ){
   ...
   * @param options
   */
  jQuery.fn.wpp_advanced_supermap_autocomplete = function( options ) {
    debug('wpp_advanced_supermap_autocomplete invoked', options.ng_app );
  ...
  function initialize() {
    ...
    jQuery( '.wpp-advanced-supermap-autocomplete').each( function( i,e ) {
      jQuery( e ).wpp_advanced_supermap_autocomplete( {
