...
class WP_Object_Cache {
  ...
  public function __construct( $persistent_id = NULL ) {
    ...
    // Get DB_NAME and sanitize it, making it more slug-like.
    if ( ! defined( 'WP_CACHE_KEY_SALT' ) ) {
      define( 'WP_CACHE_KEY_SALT', str_replace( array( '-', '/', '.', ':', '_' ), '', DB_NAME ) . ':' );
    }
  ...
  public function buildKey( $key, $group = 'default' ) {
    ...
    $_key = preg_replace( '/\s+/', '', WP_CACHE_KEY_SALT . "$prefix$group:$key" );
