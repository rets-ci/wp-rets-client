...
if( !class_exists( 'SiteOrigin_Widget_Base_Slider' ) ) include_once get_stylesheet_directory().'/lib/widgets/rdc-masthead/base/base-slider.class.php';

class Masthead_Widget extends SiteOrigin_Widget_Base_Slider {
	...
	function __construct() {
		parent::__construct(
			...
			array(
				'description' => __('RDC Masthead widget', 'so-widgets-bundle'),
...
siteorigin_widget_register('rdc-masthead', __FILE__, 'RDC Masthead');
