...
namespace UsabilityDynamics\RDC {
  ...
  /**
   * Class RDCHomeBuyingForm
   * @package UsabilityDynamics\RDC
   */
  class RDCHomeBuyingForm extends \WP_Widget {

    /**
     * init
     */
    public function __construct() {
      parent::__construct('rdc-home-buying-form', __('RDC Home Buying Form'));
    }
    ...
    public function widget($args, $instance) {
      ...
      if (!file_exists(get_stylesheet_directory() . '/static/views/rdc-home-buying-form.php')) {
        _e('Widget template not found - ' . get_stylesheet_directory() . '/static/views/rdc-home-buying-form.php');
      } else {
        include get_stylesheet_directory() . '/static/views/rdc-home-buying-form.php';
      }
  ...
  /**
   * Class RDCHomeSellingForm
   * @package UsabilityDynamics\RDC
   */
  class RDCHomeSellingForm extends \WP_Widget {

    /**
     * init
     */
    public function __construct() {
      parent::__construct('rdc-home-selling-form', __('RDC Home Selling Form'));
    }
    ...
    public function widget($args, $instance) {
      ...
      if (!file_exists(get_stylesheet_directory() . '/static/views/rdc-home-selling-form.php')) {
        _e('Widget template not found - ' . get_stylesheet_directory() . '/static/views/rdc-home-selling-form.php');
      } else {
        include get_stylesheet_directory() . '/static/views/rdc-home-selling-form.php';
      }
