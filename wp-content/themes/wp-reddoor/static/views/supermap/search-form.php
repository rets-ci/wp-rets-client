    ...
    <div class="row rdc-ranges-section">
      ...
      <div class="col-md-4 col-sm-4">
        ...
        <div class="rdc-range-fields">
          <input value="{{current_filter.available_date}}" class="available_date-input rdc-datepicker"  name="bool[must][13][range][_system.available_date][lte]" placeholder="Available Anytime" type="text" style="border:1px solid lightgrey" />
        </div>
