	...
	<div class="popupLogin popup" style="display: none;">
		...
		<ul>
			<li>
				...
				<span>Lanlord</span>
				<a target="_blank" href="https://app.propertyware.com/pw/portals/reddoorcompany/owner.action">Landlord Login</a>
			</li>
			<li>
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/static/images/src/tenant.png" alt="" />
				<span>Tenant</span>
				<a target="_blank" href="https://app.propertyware.com/pw/portals/reddoorcompany/tenant.action">Tenant Login</a>
			</li>
		</ul>
	</div>
	<div class="popupContactUsMore popup" style="display: none;">
		...
		<div>
			...
			<input id="phone" type="tel" placeholder="+919-XXX-XXX" />
