    ...
    <form class="buyForm active tab-pane" id="tabs-1" method="POST" action="">
      ...
      <div class="sfBeds">
        ...
        <ul>
          ...
          <li><input id="bed15" name="wpp_search[bedrooms][]" type="checkbox" value="1.5"/><label
                for="bed15">1.5</label></li>
      ...
      <div class="sfBaths">
        ...
        <ul>
          <li><input id="bath1" name="wpp_search[bathrooms][]" type="checkbox" value="1"/><label for="bath1">1</label>
          </li>
          <li><input id="bath15" name="wpp_search[bathrooms][]" type="checkbox" value="1.5"/><label
                for="bath15">1.5</label></li>
          <li><input id="bath2" name="wpp_search[bathrooms][]" type="checkbox" value="2"/><label for="bath2">2</label>
          </li>
          <li><input id="bath3" name="wpp_search[bathrooms][]" type="checkbox" value="3"/><label for="bath3">3</label>
          </li>
          <li><input id="bath4" name="wpp_search[bathrooms][]" type="checkbox" value="4"/><label for="bath4">4</label>
          </li>
          <li><input id="bath5" name="wpp_search[bathrooms][]" type="checkbox" value="5"/><label for="bath5">5</label>
          </li>
          <li><input id="bath6" name="wpp_search[bathrooms][]" type="checkbox" value="6"/><label for="bath6">6</label>
          </li>
        </ul>
      </div>
      <div class="sfPrice">
