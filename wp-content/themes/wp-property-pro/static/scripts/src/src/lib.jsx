...
export const Lib = {
  ...
  PROPERTY_IMAGE_SQUARE_SIZE: '600x600',
  ...
  SELECT_PROPERTY_ACTION: 'SELECT_PROPERTY',
  DESELECT_PROPERTY_ACTION: 'DESELECT_PROPERTY',
  URL_DELIMITER: '/',
  AGGREGATION_LOAD_LIMIT: 300,
  AGGREGATION_PAGE_SIZE: 10,
  POST_SUGGEST_COUNT: 10,
  TERM_SUGGEST_COUNT: 20,
  TOP_AGGREGATIONS_COUNT: 20,
