...
export default [
  ...
  {"name": "Property", "children": [
    ...
    {"name": "Lot", "items": [
      ...
      {"name": "Acres", "value": (data) => { return getAcres(data); }, 'order': 2},
      {"name": "SQFT", "value": (data) => { return getSQFT(data); }, 'order': 3},
      {"name": "Dimensions", "value": (data) => { return get(data, 'post_meta.rets_lot_size_dim[0]', null); }, 'order': 4},
      {"name": "Zoning", "value": (data) => { return getZoning(data); }, "order": 5},
      {"name": "Flood Plain", "value": (data) => { return null; }, "order": 6},
      {"name": "Road Frontage", "value": (data) => { return get(data, 'post_meta.rets_road_frontage[0]', null); }, "order": 7},
  ...
  {"name": "Listing", "children": [
    {"name": "Pricing", "items": [
      ...
      {"name": "Price Per Acre", "value": (data) => { return get(data, 'post_meta.rets_price_per_acre[0]', null); }, "order": 4},
