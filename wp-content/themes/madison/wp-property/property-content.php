	...
	<section class="property-info">
		<div class="property-attributes column-wrapper">
			...
			<?php else : ?>
				...
				<span class="property-type column col-7-12"><?php printf( __( '%1s Type', 'wpp' ), WPP_F::property_label() ); ?>: <?php echo isset( $post->property_type_label ) ? $post->property_type_label : ''; ?></span>
			<?php endif; ?>
		</div>
