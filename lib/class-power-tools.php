...
class class_wpp_power_tools {
    ...
    <table class="form-table">
      <tr>
        <td>
          ...
          <p><?php printf( __( 'User Roles capabilities management. See more details what every capability does %shere%s.', 'wpp' ), '<span class="wpp_link wpp_toggle_contextual_help">', '</span>' ); ?></p>
  ...
  function load_white_label_defaults() {
    global $wp_properties;
    $wp_properties[ 'configuration' ][ 'feature_settings' ][ 'white_label' ][ 'labels' ][ 'name' ] = __( 'Properties', 'wpp' );
  }
