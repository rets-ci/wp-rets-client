  ...
  <td>
    ...
    <ul class="wpp_property_import_alt_cron_options">
      <li>
        ...
        <label for="wpp_property_import_alt_cron_run"><?php _e( 'How often Cron should be run.', ud_get_wpp_importer()->domain ); ?></label>
      </li>
      <li>
          ...
          <td class="matches-section">
            <div>
              ...
              <ul class="advanced-options">
                <li class="clearfix">
                  <ul class="matches">
                    <li class=""><label><?php printf( __( 'Replace found matches with your custom value (%smore details%s)', ud_get_wpp_importer()->domain ), '<a target="_blank" href="https://www.usabilitydynamics.com/tutorials/attribute-matches-in-schedule-settings">', '</a>' ); ?>:</label></li>
                    <li>
                      <ul class="list">
