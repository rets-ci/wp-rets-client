...
<div id="ws-bulk-request">
  <p><?php printf( __( 'By default Walk Score is being requested on %s saving. But if you just installed the current plugin or imported %s do not have Walk Scores, you are able to generate them right now.' ), WPP_F::property_label(), WPP_F::property_label( 'plural' ) ); ?></p>
